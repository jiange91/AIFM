...
extern void refresh_neighbour_lists _PROTO_((arc_array_t&, network_t * ));
// extern void refresh_neighbour_lists _PROTO_(( network_t * ));
extern long refresh_potential _PROTO_((arc_array_t&, network_t * ));
// extern long refresh_potential _PROTO_(( network_t * ));
extern double flow_cost _PROTO_((arc_array_t&, network_t * ));
// extern double flow_cost _PROTO_(( network_t * ));
extern double flow_org_cost _PROTO_((arc_array_t&, network_t * ));
// extern double flow_org_cost _PROTO_(( network_t * ));
extern long primal_feasible _PROTO_((arc_array_t&, network_t * ));
// extern long primal_feasible _PROTO_(( network_t * ));
extern long dual_feasible _PROTO_((arc_array_t&, network_t * ));
